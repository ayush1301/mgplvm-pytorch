...
def general_kalman_covariance(A, W, Q, R, b, x_dim, Sigma0, T=None, get_sigma_tilde=False, smoothing=True, filter_entropy_terms=False, ret_smoothing_cov=False): # return all matrices independent of observations
