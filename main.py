...
class RecognitionModel(Module):
    ...
    def kalman_covariance(self, T=None, get_sigma_tilde=False, pseudo_obs=None, smoothing=True, return_covs=False): # return all matrices independent of observations
        if T is None:
            T = self.gen_model.T
        ...
        return general_kalman_covariance(A, W, Q, R, b, x_dim, Sigma0, T, get_sigma_tilde, smoothing, ret_smoothing_cov=return_covs)
