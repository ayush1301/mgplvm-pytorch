...
if __name__ == '__main__':
    ...
    neural_net = torch.nn.Sequential(torch.nn.Linear(180, 10), torch.nn.ReLU(), torch.nn.Linear(10, 10))
    main('10z', '10z_rec_NN', data_len=22800, train_len=12800, trial_len=100, z_path=z_path, datapath=datapath, dataset='Doherty', gen_load=True, full_R=True, x_dim=10, neural_net=neural_net, preprocessor=p, gen_model_fixed=gen_model_fixed, train_params_rec=train_params_rec, train_params=train_params, noise='NB', held_out_neurons=indices, CD=0.8)
